...
export default function BudgetNonExecutionForm({
  ...
  return (
    <Paper elevation={2} className="p-5 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="grid grid-cols-3 gap-3">
          ...
          <div>
            <label className={labelClass}>Статус позиций бюджета</label>
            <select name="budgetPositionStatus" className={selectClass}>
              <option value="">— Выберите —</option>
            </select>
          </div>
        </div>
